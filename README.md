...
"Duplicate..." action on each item opens the same editor pre-filled with a
copy of the selected item's data under a suggested new name — a faster
starting point than "New..." when a new entry is mostly like an existing
one.
